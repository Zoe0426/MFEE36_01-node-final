...
router.get("/", async (req, res) => {
  const sql =
    `SELECT r.name, r.city, r.area, ru.rule_name, s.service_name 
    ...
    JOIN restaurant_associated_service AS asr ON r.rest_sid = asr.rest_sid JOIN restaurant_service AS s ON asr.service_sid = s.service_sid;`;
