...
router.post('/count-item', async(req,res)=>{
    try { 
        ...
        const getCartItemNumSql = `SELECT COUNT(oc.rel_sid) AS totalItem, GROUP_CONCAT(oc.rel_sid) AS rel_sids FROM order_cart oc WHERE member_sid = ? AND order_status = '001'` 
